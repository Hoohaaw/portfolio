    ...
    <div className={styles.hero}>
      <div className={styles.heroText}>
        ...
        <div className={styles.cvRow}>
          ...
          <a href="/cv-sv.pdf" download className={styles.cvLink}>Svenska</a>
          <a href="/cv-en.pdf" download className={styles.cvLink}>English</a>
          <a href="/cv-es.pdf" download className={styles.cvLink}>Español</a>
        </div>
      </div>
